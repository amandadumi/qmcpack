...
namespace qmcplusplus
{
    ...
    SNADesc::~SNADesc(){}
     ...
     inside = std::vector<int>(nmax);
     wj = std::vector<double>(nmax,1.0);
     rcutij = std::vector<double>(nmax,1.0);
     element = std::vector<int>(nmax,1);
...
//  std::cout << "elem_duarray"<< elem_duarray << std::endl;
  ...
  for (int jjb = 0; jjb < idxb_max; jjb++) {
    ...
    const int j2 = idxb[jjb].j2;
    const int j = idxb[jjb].j;
    //std::cout << "j1,j2,j "<< j1 << " " << j2 <<" "<< j<< std::endl;
    ...
    for (int elem1 = 0; elem1 < nelements; elem1++)
      for (int elem2 = 0; elem2 < nelements; elem2++) {
        ...
        // std::cout << "zpt_r " << zlist_r[z_offset+jjz]<<std::endl;
        ...
        for (int mb = 0; 2 * mb < j; mb++)
          for (int ma = 0; ma <= j; ma++) {
            // std::cout << "dulist_r " << dulist_r[jju][0]<<std::endl;
            // std::cout << "dulist_r " << dulist_r[jju][1]<<std::endl;
            // std::cout << "dulist_r " << dulist_r[jju][2]<<std::endl;
            // std::cout << "dulist_i " << dulist_i[jju][0]<<std::endl;
            // std::cout << "dulist_i " << dulist_i[jju][1]<<std::endl;
            // std::cout << "dulist_i " << dulist_i[jju][2]<<std::endl;
            // std::cout << "zlist_r " << zlist_r[z_offset +jjz]<<std::endl;
        ...
        if (j % 2 == 0) {
          int mb = j / 2;
          for (int ma = 0; ma < mb; ma++) {
            // std::cout << "dulist_r jeven middle" << dulist_r[jju][0]<<std::endl;
            // std::cout << "dulist_r jeven middle" << dulist_r[jju][1]<<std::endl;
            // std::cout << "dulist_r jeven middle" << dulist_r[jju][2]<<std::endl;
            // std::cout << "dulist_i jeven middle" << dulist_i[jju][0]<<std::endl;
            // std::cout << "dulist_i jeven middle" << dulist_i[jju][1]<<std::endl;
            // std::cout << "dulist_i jeven middle" << dulist_i[jju][2]<<std::endl;
            // std::cout << "zlist_r " << zlist_r[z_offset +jjz]<<std::endl;
            // std::cout << "zlist_i " << zlist_i[z_offset +jjz]<<std::endl;
            for (int k = 0; k < 3; k++){
              sumzdu_r[k] +=
      ...
      //  std::cout << "end if j even" << std::endl;
        ...
        for (int k = 0; k < 3; k++){
          ...
          // std::cout << "assign dblist for db_idx " << db_idx << " and k " << k  << " is " <<dblist[db_idx][k] << std::endl;
        }
      ...
      //   std::cout << " db_idx is "<< db_idx << std::endl;
    ...
    for (int mb = 0; 2*mb <= j; mb++) {
      ...
      for (int ma = 0; ma < j; ma++) {
        ...
        for (int k = 0; k < 3; k++) {
          ...
          // std::cout<< " ulist is " << ulist_r_ij[jj][jjup]<<std::endl;
          // std::cout<< " ulisti is " << ulist_i_ij[jj][jjup]<<std::endl;
          dulist_r[jju][k] +=
