...
SNA::SNA(ParticleSet &P, double rfac0_in, int twojmax_in,
...
void SNA::grow_rij(int newnmax)
{
  ...
  std::vector rij = P.neighborlist 
  //memory->create(inside, nmax, "pair:inside");
  std::vector inside P.neighbor list inside cutoff or not
