 ...
 */
#ifndef QMCPLUSPLUS_DMC_WITH_HISTORY_H
#define QMCPLUSPLUS_DMC_WITH_HISTORY_H
 ...
 */
class DMCWithHistory : public QMCDriver, public CloneManager
{
public:
  /// Constructor.
...
private:
  ...
  DMCWithHistory(const DMCWithHistory&) = delete;
  /// Copy operator (disabled).
  DMCWithHistory& operator=(const DMCWithHistory&) = delete;
};
} // namespace qmcplusplus
